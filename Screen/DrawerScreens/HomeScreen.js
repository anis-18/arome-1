...
import { View, ScrollView ,FlatList, TouchableOpacity , Text, Dimensions, Image, ActivityIndicator, AsyncStorage } from 'react-native';
...
export default class HomeScreen extends React.PureComponent {
	...
	render() {
		if(this.state.category){		
			return (
			<ScrollView showsVerticalScrollIndicator={false} removeClippedSubviews={true} style={styles.lightBody}>
				<FlatList
